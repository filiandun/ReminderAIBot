...
namespace ReminderAIBot.Infrastructure.Messaging.ReceiverService
{
    public class TelegramReceiverService : BackgroundService, IReceiverService
    {
        ...
        private readonly Presentation.Handlers.UpdateHandler.IUpdateHandler _messageHandler;


        public TelegramReceiverService(ILogger<TelegramReceiverService> logger, IHostEnvironment hostEnvironment, IOptions<TelegramBotConfig> options, ITelegramBotClient telegramBotClient, Presentation.Handlers.UpdateHandler.IUpdateHandler messageHandler)
        {
            this._logger = logger;
